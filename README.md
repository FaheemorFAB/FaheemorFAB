...
I build applications end-to-end — not just features, but systems that **think, analyze, and optimize**. My work spans clean UIs, robust APIs, and ML-driven data pipelines.

Currently diving deep into scalable backend architecture, machine learning integration, and distributed systems design.

```text
JavaScript · TypeScript · Python · SQL
Full-Stack  →  Backend APIs  →  ML & Automation
```
